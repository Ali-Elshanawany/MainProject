...
using FinalBoatSystemRental.Application.Owner.Query;
...
public class OwnerController : ControllerBase
{
    ...
    [HttpGet("View-PendingOwners")]
    public async Task<IActionResult> GetPendingOwner()
    {
        try
        {

            Log.Information($"View Pending Owners ");
            var owners = new ListPendingOwnersQuery();
            var result = await _mediator.Send(owners);
            return Ok(result);
        }
        catch (Exception ex)
        {
